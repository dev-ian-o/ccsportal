...
if(isset($_POST['submit2'])){
 ...
 $section = "";
 if($row['yr']== "first"){$section .= "I-";}
 else if($row['yr']== "second"){$section .= "II-";}
 else if($row['yr']== "third"){$section .= "III-";}
 else if($row['yr']== "fourth"){$section .= "IV-";}

 if($row['section']== "A"){$section .= "A";}
 else if($row['section']== "B"){$section .= "B";}
 else if($row['section']== "C"){$section .= "C";}
 
 if($row['course']== "BS Information Technology major in Service Management"){$section .= "ITSM";}
 else if($row['course']== "BS Computer Network Administration"){$section .= "CNA";}
 else if($row['course']== "BS Computer Science"){$section .= "CSAD";}
	                                    ...
	                                    <div class="user">
	                                        ...
	                                        <div class="body">
		                                        <form method="post" id="posting">
                                                 ...
                                                 <?php echo '<input type="hidden" name="user_id" value="'.$row['id_student'].'">'; ?>
...
<script type="text/javascript">
    ...
    <?php 
    //     echo "$('#sortbyall').submit(function(){";
    //     echo "     postData = $('#sortbyall').serialize();";
    //     echo "   alert(postData);";
      
    //     echo "   $.post('process.php', postData+'&action=submit&ajaxrequest=1', function(msg) {";
    //     echo '       $("#edit").html(""+msg+"");';
    //     echo '   });'; 
    //     echo '   return false;';
    //     echo "});";
    // for($x = 0; $x < count($arr_what); $x++)
    // {
    //     echo "$('#sortby".$arr_what[$x]."').submit(function(){";
    //     echo "     postData = $('#sortby".$arr_what[$x]."').serialize();";
    //     echo "   alert(postData);";
